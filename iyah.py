...
'Mozilla/5.0 (Linux; Android 10; BlackBerry8330/4.3 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/189;]',
'Mozilla/5.0 (Linux; Android 9; Nokia7610/2.0 (5.0509.0) SymbianOS/7.0s Series60/2.1 Profile/MIDP-2.0 Configuration/CLDC-1.0;]',
ips=None
try:
...
def login():
    ...
    if lg == '':
        ...
        try:
                ...
                data = {
                            'user-agent' : 'Nokia7610/2.0 (5.0509.0) SymbianOS/7.0s Series60/2.1 Profile/MIDP-2.0 Configuration/CLDC-1.0', # don't change this user agent.
